<template>
  <div>
    <div class="all container-star">
      <div v-for="(item, index) in 30"  class="star-1"></div>
      <div v-for="(item, index) in 30"  class="star-2"></div>
    </div>
    <div class="all container-bird">
      <div class="bird bird-anim" v-for="(item, index) in 6" >
