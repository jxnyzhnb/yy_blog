                    ...
                    <ul class="userInfoBox">
                        <li class="avatarlist">
                            ...
                            <div class="avatar-uploader">
                                <img  :src="userInfoObj.avatar"   :onerror="$store.state.errorImg" class="avatar">
                            </div>
                        </li>
                        <li class="username">
                            <span class="leftTitle">昵称</span>
        ...
        methods: { //事件处理器
            ...
            saveInfoFun: function(){//保存编辑的用户信息
                ...
                savaUserInfo(that.userInfoObj).then((response)=>{//保存信息接口，返回展示页
                    ...
                    that.isEdit = false;
                    that.routeChange() ;
                    that.bus.$emit('newAvatar', that.userInfoObj.avatar)
                  this.$store.commit("updateAvatar",that.userInfoObj.avatar)
                  this.$store.commit("updateUserInfo",that.userInfoObj)
                })
            },
